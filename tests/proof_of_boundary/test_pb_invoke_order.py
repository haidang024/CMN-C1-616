    ...
    def test_call_order_for_every_node(self, monkeypatch):
        ...
        for node_cls in node_classes:
            ...
            state = {
                ...
                "input_context": {
                    "raw": "Find all engineers in the Tokyo cost center",
                    "workday_tenant_url": "https://mock.workday.com/api/common/v1/acme",
                },
                "natural_language_query": "Find all engineers in the Tokyo cost center",
                "workday_tenant_url": "https://mock.workday.com/api/common/v1/acme",
                "validated_query": "Find all engineers in the Tokyo cost center",
                "validated_tenant_url": "https://mock.workday.com/api/common/v1/acme",
            }
            instance(state)
